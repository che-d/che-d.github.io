$(document).ready(function() {
	$('.telefone__wrap').hover(function(){
		...
		// $('.telefone__img_wrap:after').css({'-webkit-animation': 'pulse1 2s linear infinite','-moz-animation': 'pulse1 2s linear infinite','animation': 'pulse1 2s linear infinite'});
	}, function() {
		...
		// $('.telefone__img_wrap:after').css('button_run_left');
	});
});